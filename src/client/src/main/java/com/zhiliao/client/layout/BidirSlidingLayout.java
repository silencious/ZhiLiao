...
public class BidirSlidingLayout extends RelativeLayout implements OnTouchListener {
	...
	public BidirSlidingLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		//2015/7/28 15:04 WindowManager wm = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (changed) {
			...
			leftMenuLayoutParams.width = screenWidth - 80;
			rightMenuLayoutParams.width = screenWidth - 80;
			contentLayout.setLayoutParams(contentLayoutParams);
		}
	}
